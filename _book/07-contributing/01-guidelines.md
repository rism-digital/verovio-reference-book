...
Verovio uses a [ClangFormat](http://clang.llvm.org/docs/ClangFormat.html) (**22.0**) coding style based on the [WebKit](https://webkit.org/code-style-guidelines/) style, with a few minor modifications. The modifications include:
