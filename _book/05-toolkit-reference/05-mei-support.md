...
{% endcol %}
{% col 10 %}
[att.coordinated](https://music-encoding.org/guidelines/dev/attribute-classes/att.coordinated.html), [att.typed](https://music-encoding.org/guidelines/dev/attribute-classes/att.typed.html)
{% endcol %}
{% endrow %}
