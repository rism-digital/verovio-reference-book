...
endings = ["anl", "base", "cmn", "ges", "log", "logical", "pitched", "quality", "vis"] 

attribute_classes_exceptions = {
    "att.time.base": "att.timeBase"
}

element_exceptions = ["barLineAttr", "boundaryEnd", "dots", "flag", "page", "pages", "object", "stem", "system", "textElement", "timestampAttr", "tupletBracket", "tupletNum"]
